...
tkWindow = tkinter.Tk()
tkWindow.wm_title("Embedding in Tk")
...
toolbar = NavigationToolbar2Tk(canvas, tkWindow, pack_toolbar=False)
toolbar.update()
...
button = tkinter.Button(master=tkWindow, text="Quit", command=tkWindow.quit)
